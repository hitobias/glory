...
<main id="main-content" class="site-main">
    ...
    <section class="bg-gradient-to-br from-accent-green to-dark py-12 md:py-16">
        <div class="container-content text-center">
            <?php the_archive_title('<h1 class="text-h2 md:text-h1 text-white mb-2">', '</h1>'); ?>
            <?php the_archive_description('<p class="text-white/70 text-body-sm md:text-body max-w-xl mx-auto">', '</p>'); ?>
        </div>
    </section>
        ...
        <div class="container-content">
            ...
            <?php else : ?>
                <div class="text-center py-16">
                    <p class="text-dark-400 text-body-lg mb-6">此分類目前沒有文章。</p>
