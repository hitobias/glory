...
<footer class="bg-gradient-to-br from-accent-green to-dark text-white">
    ...
    <div class="container-content py-10 md:py-16">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-0 md:gap-10">
            <!-- Brand -->
            <div class="md:col-span-1 pb-7 md:pb-0 border-b border-white/10 md:border-0">
                <img src="<?php echo esc_url(GLORY_THEME_URI . '/assets/images/logo.png'); ?>" alt="得榮基金會" class="h-9 md:h-12 w-auto mb-3 brightness-0 invert">
                <p class="text-white/70 text-body-sm leading-relaxed mb-5 max-w-xs">
            ...
            <!-- Links (2 sub-columns on every size) -->
            <div class="md:col-span-2 py-7 md:py-0 border-b border-white/10 md:border-0">
                <div class="grid grid-cols-2 gap-6 md:gap-10">
                    <!-- Services -->
                    <div>
                        <h4 class="text-sm font-semibold text-white mb-3 md:mb-4">服務項目</h4>
                    ...
                    <!-- Quick Links -->
                    <div>
                        <h4 class="text-sm font-semibold text-white mb-3 md:mb-4">快速連結</h4>
                        <ul class="list-none m-0 p-0 space-y-2.5">
            ...
            <!-- Contact -->
            <div class="md:col-span-1 pt-7 md:pt-0">
                <h4 class="text-sm font-semibold text-white mb-3 md:mb-4">聯絡資訊</h4>
                <ul class="list-none m-0 p-0 space-y-3">
                    <li class="flex items-start gap-2.5">
                        <?php echo glory_get_icon('location', 'w-4 h-4 mt-0.5 flex-shrink-0 text-white/50'); ?>
                        <span class="text-white/70 text-body-sm leading-relaxed">台北市信義路四段460號3F-1</span>
                    </li>
                    <li class="flex items-center gap-2.5">
                        <?php echo glory_get_icon('phone', 'w-4 h-4 flex-shrink-0 text-white/50'); ?>
                        <a href="tel:02-87881930" class="text-white/70 hover:text-accent transition-colors no-underline text-body-sm">(02)8788-1930</a>
                    </li>
                    <li class="flex items-center gap-2.5">
                        <?php echo glory_get_icon('fax', 'w-4 h-4 flex-shrink-0 text-white/50'); ?>
                        <span class="text-white/70 text-body-sm">(02)8788-3547</span>
                    </li>
                    <li class="flex items-center gap-2.5">
                        <?php echo glory_get_icon('mail', 'w-4 h-4 flex-shrink-0 text-white/50'); ?>
                        <a href="mailto:glory@glory.org.tw" class="text-white/70 hover:text-accent transition-colors no-underline text-body-sm break-all">glory@glory.org.tw</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="border-t border-white/10">
        <div class="container-content py-4 pr-16 md:pr-0 text-center">
            <p class="text-white/45 text-xs md:text-xs leading-relaxed m-0">
                &copy; <?php echo esc_html(date('Y')); ?> 財團法人台北市私立得榮社會福利基金會<br class="md:hidden">
                <span class="md:ml-1">All Rights Reserved.</span>
            </p>
        </div>
    </div>
</footer>
